def rename_files(desired_name, num_digits, source_ext, target_ext, range_old_name=[]):
    import os
...
rename_files(desired_name='new_file_', num_digits=3, source_ext='txt', target_ext='doc', range_old_name=[3, 6])